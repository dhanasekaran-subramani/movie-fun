...
public class AlbumsDatabaseConfig {
    ...
    @Bean
    DataSource albumsDataSource(DatabaseServiceCredentials serviceCredentials) {
    ...
    LocalContainerEntityManagerFactoryBean albumsEntityManagerFactory(
        ...
        albumsEntityManagerFactory.setPersistenceUnitName("albums");
    ...
    PlatformTransactionManager albumsPlatformTransactionManager(EntityManagerFactory albumsEntityManagerFactory) {
        JpaTransactionManager albumsJpaTransactionManager = new JpaTransactionManager();
        albumsJpaTransactionManager.setEntityManagerFactory(albumsEntityManagerFactory);
